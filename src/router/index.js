...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: 'Admin Management', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
...
export const asyncRoutes = [
...

  {
    ...
    name: 'stat',
    meta: { title: 'stat', icon: 'example' },
    children: [
      {
        path: 'create',
        name: 'create stat',
        component: () => import('@/views/edu/stat/create'),
        meta: { title: 'create stat', icon: 'table' }
      },
      {
        path: 'show',
        name: 'echart',
        component: () => import('@/views/edu/stat/show'),
        meta: { title: 'echart', icon: 'tree' }
      }
    ]
  },
